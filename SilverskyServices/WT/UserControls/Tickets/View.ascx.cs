...
public partial class UserControls_Tickets_View : System.Web.UI.UserControl
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (ilResult != -1)
        {
            ...
            TicketOpenSendMail(EntCategory, EntTicket);
            Response.Redirect("Default.aspx");
        }
        else
        {
    ...
    private void TicketOpenSendMail(Category EntCategory, Ticket lastTicket)
    {
        ...
        sbBody.AppendLine("<br/>");
        sbBody.AppendLine(String.Format("Para cerrar el ticket da clic aqui:<a href=\"{0}/WT/Tickets/Close.aspx?IdTicket={1}\" >Cerrar Ticket</a>",PortalAddress, lastTicket.IdTicket));
        sbBody.AppendLine("</p>");

...
namespace CaptchaCtrl
{
    ...
    public class CaptchaImage
    {
        ...
        {
            int ilTop = rect.Top;
            int ilBottom = rect.Bottom;
            PointF newPoint = RandomPoint(rect.Left, rect.Width, ref ilTop, ref ilBottom);
            return newPoint;
        }
        ...
        private void WarpText(GraphicsPath textPath, Rectangle rect)
        {
            ...
            //int ilTop = top;
            int ilTopRange = top + hrange;

            PointF leftTop = RandomPoint(left, left + wrange, ref top, ref ilTopRange);
            PointF rightTop = RandomPoint(width - wrange, width, ref top, ref ilTopRange);
            ilTopRange = height - hrange;
            PointF leftBottom = RandomPoint(left, left + wrange, ref ilTopRange, ref height);
            PointF rightBottom = RandomPoint(width - wrange, width, ref ilTopRange, ref height);
        ...
        private void AddLine(Graphics graphics1, Rectangle rect)
        {
            ...
            for (int l = 1; l <= linecount; l++)
            {
                ...
                graphics1.DrawCurve(p, pf, (float)1.75);
            }
